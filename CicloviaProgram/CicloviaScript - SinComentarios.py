...
class SimulationDES:
    ...
    #This definition adds a value for the statistic of the time in the system        
    def timeInSystemStatistic(self, timeInSystem):             
        self.listTimeInSystem.append(timeInSystem)
    
    #This definition estimates the time un
    ...
    #This definition shows the bar chart!    
    ...
    #This definition prints the main results
