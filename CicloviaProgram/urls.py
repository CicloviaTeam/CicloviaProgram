...
urlpatterns = patterns('',
    ...
    url(r'^(?P<ciclovia_id>\d+)/simulationResultsValidationOneRun'+
        ...
        name='detailTrackValidationSingleRun'),
                       #Paginas de simulación inversa
    url(r'^(?P<ciclovia_id>\d+)/inverseSimulation/$', views.inverseSimulationWarning,
        name='inverseSimulation'),
    url(r'^(?P<ciclovia_id>\d+)/inverseSimulationExecution/$',
        views.inverseSimulationExecution, name='inverseSimulationExecution'),
                       # Gráficas
