...
class SimulationDES:
    ...
    def participantArrivals(self):     
        ...
        timeParticipantsSystem = self.weightedValues(durationValuesArray, durationProbabilitiesArray, (self.ciclovia.maxArrivals*55))
        print("llegoooo")
    ...
    def printResults(self, cicloviaId):
        ...
        for track in self.ciclovia.tracks:
            ...
            for timeInterval in track.flowInTrack:
                print("   El flujo en la hora " + str(hour) + " es de " + str(timeInterval))
                hour+=1
...
#This method executes the simulation
def simulationExecutionValidation(cicloviaId, isValid):
